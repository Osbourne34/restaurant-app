...
const OrderItem = ({ id, title, photo, price, amount }) => {
    return (
        <li className="order-item">
            <div className="order-item__info">
                ...
                <div className="order-item__counter">
                    <button className="order-item__counter-btn increase">+</button>
                    <p className="order-item__amount">{amount}</p>
                    <button className="order-item__counter-btn decrease">-</button>
                </div>
            </div>
